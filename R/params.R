...
#' @description Provides a list of the models with their respective parameters and properties.
...
#' @return seq A logical indicator if the parameter is sequential in the model (i.e. if model is able to fit all 'lower' parameters simultaneously)
#' @export
